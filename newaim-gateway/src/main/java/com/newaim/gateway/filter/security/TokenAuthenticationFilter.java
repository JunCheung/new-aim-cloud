...
import static com.newaim.framework.common.util.cache.CacheUtils.buildAsyncReloadingCache;
import static com.newaim.framework.common.util.cache.CacheUtils.buildCache;
...
public class TokenAuthenticationFilter implements GlobalFilter, Ordered {
    ...
    private LoginUser buildUser(String body) {
        ...
        return new LoginUser().setId(tokenInfo.getUserId()).setUserType(tokenInfo.getUserType()).setScopes(tokenInfo.getScopes());
    }

    @Override
    public int getOrder() {
        return WebFilterOrderEnum.TOKEN_AUTHENTICATION_FILTER;
    }
