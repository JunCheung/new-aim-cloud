package com.newaim.framework.web.core.util;

import cn.hutool.core.util.NumberUtil;
import cn.hutool.extra.servlet.ServletUtil;
import com.newaim.framework.common.enums.RpcConstants;
import com.newaim.framework.common.enums.TerminalEnum;
...
public class WebFrameworkUtils {
     ...
     * 终端的 Header
     *
     * @see com.newaim.framework.common.enums.TerminalEnum
     */
    ...
    public static Integer getLoginUserType(HttpServletRequest request) {
        ...
        if (request.getServletPath().startsWith(properties.getPubApi().getPrefix())) {
