...
public class NewaimWebSecurityConfigurerAdapter {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(c -> c
                        ...
                        // 1.2 基于 newaim.security.permit-all-urls 无需认证
                        .requestMatchers(securityProperties.getPermitAllUrls().toArray(new String[0])).permitAll()
                        // 1.3 设置 App API 无需认证
                        .requestMatchers(buildPubApi("/**")).permitAll()
                )
                // ②：每个项目的自定义规则
    ...
    private String buildPubApi(String url) {
